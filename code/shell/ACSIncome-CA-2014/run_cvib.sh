...
export DATANAME="ACSIncome-CA-2014"
...
# jobs
parallel -j10 job {1} {2} {3} ::: 1e-2 2e-2 3e-2 4e-2 5e-2 6e-2 7e-2 8e-2 9e-2 1e-1 2e-1 3e-1 4e-1 5e-1 6e-1 7e-1 8e-1 9e-1 1e0 ::: 1e-3 1e-2 1e-1 ::: cuda:0